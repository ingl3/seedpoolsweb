...
//uncomment this part, if you want repost only notifications with blocks, epochsum, dailysum
	...
	if(!$_POST[msg] or !in_array($_POST[type],array("stake","blocks","epochsum","dailysum")))
		die(); 

  function bot($method,$datas=[]){
      $url = "https://api.telegram.org/1521234673:AAEYzVqmjNV6pnqf5LVNkU_XGNCVmVgv4t8
/".$method; // APIKEY replace with yours; do not remove from start "bot"; ie: bot123456789:AABBCCDDEEFF_HHQQ
      $ch = curl_init();
